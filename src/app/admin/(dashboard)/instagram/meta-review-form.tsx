...
export default function MetaReviewForm() {
  ...
  return <section className="border rounded p-4 space-y-3">
    ...
    <p>Enlace reutilizable por 60 días, solo para el portal de Instagram. No permite entrar al administrador. Cualquiera con el enlace puede usarlo: compartilo únicamente en el formulario privado de revisión de Meta.</p>
