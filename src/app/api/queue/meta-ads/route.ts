...
import { processPausedAd } from '@/lib/queue/meta-ads';
...
export async function POST(request: Request) {
  ...
  try {
    await processPausedAd(jobId);
    return Response.json({ received: true, message: 'Consultar el resultado en SmartBrew; delivered no implica anuncio creado.' });
