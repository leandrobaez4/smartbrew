...
vi.mock('@/lib/queue/product-publish', () => ({ processProductPublish: m.process }));
...
const request = (body = '{"jobId":"job123"}') => new Request('https://www.smartbrew.tech/api/queue/product-publish', { method: 'POST', body });
