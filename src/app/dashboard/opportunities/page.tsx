...
export default async function OpportunitiesPage({ searchParams }: {
  ...
  return <div className="mx-auto max-w-[1500px]">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4"><div><p className="text-sm font-semibold text-yellow-600">Dropshipping</p><h1 className="text-2xl font-bold">Oportunidades</h1><p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Productos configurados ordenados por rentabilidad estimada. Los que no tienen stock siguen visibles para revisión.</p></div><Link href="/admin/suppliers" className="rounded border border-gray-300 px-4 py-2 text-sm dark:border-gray-700">Administrar proveedores</Link></div>
